...
def draw_bbox(img, label_tensor_nx6, img_id):
    ...
    cv2.imwrite(f"Inference_Results/{img_id}.jpg", image)
...
if __name__ == "__main__" :
    ...
    parser.add_argument("--weights_path", type=str, default="checkpoints/2lm4a6sz/yolov3_ckpt_499.pth", help="path to weights file")
    parser.add_argument("--root_test", type=Path, default="synData_test", help="root directory containing rgb images")
